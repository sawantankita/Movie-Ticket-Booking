...
public class Baaghi3frm extends JFrame implements ActionListener
{
	...
	public Baaghi3frm()
	{
		...
		i3=new ImageIcon("baaghi31_poster.JPG");
	
		l15.setIcon(i3);

		t1=new JTextField();
		t2=new JTextField(" Baaghi3");
		t3=new JTextField(" Rs. 160/-");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(s1.equals("View"))
		{
			...
			if(s3.equals("Premium"))
			{
				...
				t10.setText(" "+(160*y1)+"/- Only ");
			}
			if(s3.equals("VIP"))
			{
				t3.setText("Rs. 270/-");
				int y1=Integer.parseInt(t6.getText());	//billing
				t10.setText(" "+(270*y1)+"/- Only ");
			}
			if(s3.equals("Silver"))
			{
				t3.setText("Rs. 210/-");
				int y1=Integer.parseInt(t6.getText());	//billing
				t10.setText(" "+(210*y1)+"/- Only ");
			}
		}
		if(s1.equals("Clear"))
		{
