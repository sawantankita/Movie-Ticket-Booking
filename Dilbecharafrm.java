...
public class Dilbecharafrm extends JFrame implements ActionListener
{
	JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18;
	JButton b1,b2,b3,b4,b5,b6;
	JTextField t1,t2,t3,t4,t5,t6,t7,t8,t9,t10;
	ImageIcon i1,i2,i3;
	public Dilbecharafrm()
	{
		setSize(1950,990);
		setVisible(true);
		//setTitle("Dilbecharafrm");
		...
		i3=new ImageIcon("dilbechara1_poster.PNG");
	
		l15.setIcon(i3);

		t1=new JTextField();
		t2=new JTextField(" Dil Bechara");
		t3=new JTextField(" Rs. 250/-");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(s1.equals("View"))
		{
			...
			if(s3.equals("Premium"))
			{
				...
				t10.setText(" "+(250*y1)+"/- Only ");
			}
			if(s3.equals("VIP"))
			{
				t3.setText("Rs. 400/-");
				int y1=Integer.parseInt(t6.getText());	//billing
				t10.setText(" "+(400*y1)+"/- Only ");
			}
			if(s3.equals("Silver"))
			{
				t3.setText("Rs. 350/-");
				int y1=Integer.parseInt(t6.getText());	//billing
				t10.setText(" "+(350*y1)+"/- Only ");
			}
