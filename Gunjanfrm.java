...
public class Gunjanfrm extends JFrame implements ActionListener
{
	...
	public Gunjanfrm()
	{
		...
		i3=new ImageIcon("gunjan1_poster.JPG");
	
		l15.setIcon(i3);

		t1=new JTextField();
		t2=new JTextField(" Gunjan Saxena");
		t3=new JTextField(" Rs. 220/-");
