...
public class Simmbafrm extends JFrame implements ActionListener
{
	...
	public Simmbafrm()
	{
		...
		i3=new ImageIcon("simmba1_poster.JPG");
	
		l15.setIcon(i3);

		t1=new JTextField();
		t2=new JTextField(" Simmba");
		t3=new JTextField(" Rs. 180/-");
